  ...
  return (
    <>
      {!wallet.connected ? (
        ...
        <>
          <p>Магазин не инициализирован</p>
          <Link to={`/`}>Инициализировать</Link>
        </>
      )}
    </>
  );
...
function ArtistModal({
  ...
  return (
    <>
      ...
      <Button onClick={() => setModalOpen(true)}>Добавить создателя</Button>
    </>
  );
}
    ...
    <Content className={'admin-content'}>
            ...
            <Row>
              ...
              >
                {loading ? (
                  ...
                  <span>Преобразование допустимых основных изданий</span>
                )}
              </Button>
            </Row>
          </Col>{' '}
      ...
      <Col>
        <p style={{ marginTop: '30px' }}>
          Повышение эффективности существующих аукционов.
        </p>
        <Row>
          <Button
            disabled={loading}
          ...
          >
            {loading ? <Spin /> : <span>Обновить аукцион</span>}
          </Button>
        </Row>
      </Col>
    </Content>
